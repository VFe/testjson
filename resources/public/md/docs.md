...
Two middleware functions are provided by default in the `testjson.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `testjson.handler` namespace to manage the enabled middleware.
